...
public static void main(String[] args) {
        ...
        char playAgain = 'y';
        YahtzeeTest yt = new YahtzeeTest();
        ...
        while (playAgain == 'y') {
            ...
            yt.sortArray(hand, DICE_IN_PLAY);
